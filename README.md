...
```bash
L=/usr/local/bin/conoha-ojs && curl -sL https://github.com/hironobu-s/conoha-ojs/releases/download/20150104.1/conoha-ojs.darwin.amd64.gz | zcat > $L && chmod +x $L
```
...
```bash
L=/usr/local/bin/conoha-ojs && curl -sL https://github.com/hironobu-s/conoha-ojs/releases/download/20150104.1/conoha-ojs.linux.386.gz | zcat > $L && chmod +x $L
```
...
[ZIPファイル](https://github.com/hironobu-s/conoha-ojs/releases/download/20150104.1/conoha-ojs.zip)をダウンロードして、適当なフォルダに展開します。
